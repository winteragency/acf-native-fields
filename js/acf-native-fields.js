(function ($) {
  var ACF_Native_Fields = {
    ...
    init: function () {
      ...
      ACF_Native_Fields.native_fields =
        ACF_Native_Fields.editor_container.find('.acf-native-field');
    ...
    getNativeFieldElement: function (selector) {
      return ACF_Native_Fields.handlePostbox(
        ACF_Native_Fields.editor_container.find(selector)
      );
    },
    ...
    moveNativeField: function () {
      ...
      if (
        typeof ACF_Native_Fields['moveNativeField_' + native_field_type] ===
        'function'
      ) {
        native_field_placeholder.append(
          ACF_Native_Fields['moveNativeField_' + native_field_type](
      ...
      // If no built-in or custom method exists, give up and show a message about the problem instead.
        ...
        native_field_placeholder.html(
          acf._e('native_field', 'not_implemented')
        );
      }
    },
    ...
    moveNativeField_yoast_seo: function () {
      return ACF_Native_Fields.getNativeFieldElement(
        '#wpseo_meta, #tsf-inpost-box'
      );
    },
    ...
    moveNativeField_custom: function (native_field_placeholder) {
      return ACF_Native_Fields.getNativeFieldElement(
        '#' + native_field_placeholder.data('metabox-id')
      );
    }
  };
